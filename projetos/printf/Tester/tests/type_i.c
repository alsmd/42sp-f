...
void	type_i_tester()
{
	...
	/*----------2------------*/
	#define PARAM "Some string %10iZ", 41203901
	{
		bzero(buffer_1, 1000);
		bzero(buffer_2, 1000);
		redirect("tmp");
	...
	#undef PARAM
	/*----------4------------*/
	#define PARAM "Some string %0 0+0-0-0##-0--10.13iZ",  41203901
	{
		bzero(buffer_1, 1000);
		bzero(buffer_2, 1000);
		redirect("tmp");
	...
	/*----------5------------*/
	#define PARAM "Some string % iZ",  -41203901
	{
		bzero(buffer_1, 1000);
		bzero(buffer_2, 1000);
		redirect("tmp");
	...
	/*----------6------------*/
	#define PARAM "Some string %010iZ",  41203901
	{
		bzero(buffer_1, 1000);
		bzero(buffer_2, 1000);
		redirect("tmp");
	...
	#undef PARAM	/*----------6------------*/
	#define PARAM "Some string %015.12iZ",  41203901
	{
		bzero(buffer_1, 1000);
		bzero(buffer_2, 1000);
		redirect("tmp");
	...
	/*----------8------------*/
	#define PARAM "Some string %0-15.12iZ", 41203901
	{
		bzero(buffer_1, 1000);
		bzero(buffer_2, 1000);
		redirect("tmp");
